...
public interface ISets
{
    ...
    /// <summary>
    /// Returns a Set with the given ID.
    /// </summary>
    /// <param name="setId">The Scryfall ID</param>
    /// <returns></returns>
    Task<Set?> Get(Guid setId);

    /// <summary>
    /// Returns a Set with the given TCG Player ID.
    /// </summary>
    /// <param name="setId"></param>
    /// <returns></returns>
    Task<Set?> GetByTcgPlayerId(int setId);
}
